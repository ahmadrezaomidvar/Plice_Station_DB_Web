<?php
    ...
    $name = $_POST['username'];
    $sql_admin = "SELECT * FROM admin_at WHERE done_by = '$name' ORDER BY done_at DESC";
    $result_admin = $mysqli->query($sql_admin);
    $sql_fines = "SELECT * FROM fines_at WHERE done_by = '$name' ORDER BY done_at DESC";
    $result_fines = $mysqli->query($sql_fines);
    $sql_people = "SELECT * FROM people_at WHERE done_by = '$name' ORDER BY done_at DESC";
    $result_people = $mysqli->query($sql_people);
    $sql_vehicle = "SELECT * FROM vehicle_at WHERE done_by = '$name' ORDER BY done_at DESC";
    $result_vehicle = $mysqli->query($sql_vehicle);
    $sql_incident = "SELECT * FROM incident_at WHERE done_by = '$name' ORDER BY done_at DESC";
    $result_incident = $mysqli->query($sql_incident);
    $sql_offence = "SELECT * FROM offence_at WHERE done_by = '$name' ORDER BY done_at DESC";
    $result_offence = $mysqli->query($sql_offence);
    $sql_officer = "SELECT * FROM officer_at WHERE done_by = '$name' ORDER BY done_at DESC";
